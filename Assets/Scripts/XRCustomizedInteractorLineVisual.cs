...
namespace UnityEngine.XR.Interaction.Toolkit {
    ...
    public class XRCustomizedInteractorLineVisual : MonoBehaviour, IXRCustomReticleProvider {
        ...
        [SerializeField]
        /// <summary>
        /// ADDED Element : Controls the color of the line when reloading
        /// </summary>
        Gradient m_reloadColorGradient = new Gradient {
            colorKeys = new[] { new GradientColorKey(new Color(0.2F, 0.3F, 0.4F), 0f), new GradientColorKey(new Color(0.2F, 0.3F, 0.4F), 1f) },
            alphaKeys = new[] { new GradientAlphaKey(1f, 0f), new GradientAlphaKey(1f, 1f) },
        };
        /// <summary>
        /// Controls the color of the line as a gradient from start to end to indicate an invalid state.
        /// </summary>
        public Gradient reloadColorGradient {
            get => m_reloadColorGradient;
            set => m_reloadColorGradient = value;
        }


        [SerializeField]
        /// <summary>
        /// ADDED Element : Controls wether the player projectile is reloading
        /// </summary>
